...
import com.pixelturf.singpraises.Activities.DailyReadingActivity;
import com.pixelturf.singpraises.Activities.MainActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                if (position == 0) {
                    Intent india = new Intent( context, DailyReadingActivity.class);
